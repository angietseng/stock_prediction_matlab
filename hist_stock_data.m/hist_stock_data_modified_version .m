...
%yyyy or Matlab datenums, where X is the beginning date and Y is the
...
%
%   EXAMPLES
%       stocks = hist_stock_data('01232003','04152008','GOOG','C');
...
%
%       stocks = hist_stock_data('10121997','09182001','tickers.txt');
...
%
%       stocks = hist_stock_data('10121997','09182001','C','frequency','w')
...
% Created by Josiah Renfree on January 25, 2008
% Modified by Angeline Tseng on November 29, 2021
...
origDate = datenum('Jan-01-1970 00:00:00', 'mmm-dd-yyyy HH:MM:SS');

% Convert input dates to Matlab datenums, if necessary
if ischar(start_date)
    startDate = (datenum(start_date, 'mmddyyyy') - origDate) * 24 * 60 * 60;
else
